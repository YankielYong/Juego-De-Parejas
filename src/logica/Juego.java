...
public class Juego {
	...
	private void crearCasillas(){
		ImageIcon imgBajarEscalera = new ImageIcon(Juego.class.getResource("/imagenes_casillas/baja escalera.png"));
		...
		ImageIcon imgCruzarPuente = new ImageIcon(Juego.class.getResource("/imagenes_casillas/cruza puente.png"));
		...
		ImageIcon imgConfesion = new ImageIcon(Juego.class.getResource("/imagenes_casillas/confesion p.png"));
		...
		ImageIcon imgRopaFuera = new ImageIcon(Juego.class.getResource("/imagenes_casillas/ropa fuera p.png"));
		...
		ImageIcon imgBeso = new ImageIcon(Juego.class.getResource("/imagenes_casillas/beso p.png"));
		Image besoArr = imgBeso.getImage().getScaledInstance(120, 90, Image.SCALE_SMOOTH);
		Icon iconBeso = new ImageIcon(besoArr);
		
		ImageIcon imgBesoCuello = new ImageIcon(Juego.class.getResource("/imagenes_casillas/beso cuello p.png"));
		...
		ImageIcon imgBesoCarinyo = new ImageIcon(Juego.class.getResource("/imagenes_casillas/beso carinyoso p.png"));
		...
		ImageIcon imgLamer = new ImageIcon(Juego.class.getResource("/imagenes_casillas/lamer p.png"));
		Image lamerArr = imgLamer.getImage().getScaledInstance(120, 90, Image.SCALE_SMOOTH);
		Icon iconLamer = new ImageIcon(lamerArr);
		
		ImageIcon imgMorder = new ImageIcon(Juego.class.getResource("/imagenes_casillas/morder p.png"));
		Image morderArr = imgMorder.getImage().getScaledInstance(120, 90, Image.SCALE_SMOOTH);
		Icon iconMorder = new ImageIcon(morderArr);
		
		ImageIcon imgDemostracion = new ImageIcon(Juego.class.getResource("/imagenes_casillas/demostracion p.png"));
		...
		ImageIcon imgDescripcion = new ImageIcon(Juego.class.getResource("/imagenes_casillas/descripcion p.png"));
		...
		ImageIcon imgBaileSexy = new ImageIcon(Juego.class.getResource("/imagenes_casillas/baile sexy p.png"));
		...
		ImageIcon imgMasaje = new ImageIcon(Juego.class.getResource("/imagenes_casillas/masaje p.png"));
		Image masajeArr = imgMasaje.getImage().getScaledInstance(120, 90, Image.SCALE_SMOOTH);
		Icon iconMasaje = new ImageIcon(masajeArr);
		
		ImageIcon imgEscogePrueba = new ImageIcon(Juego.class.getResource("/imagenes_casillas/escoge prueba p.png"));
		...
		ImageIcon imgNalgada = new ImageIcon(Juego.class.getResource("/imagenes_casillas/nalgada p.png"));
		...
		ImageIcon imgACiegas = new ImageIcon(Juego.class.getResource("/imagenes_casillas/a ciegas p.png"));
		...
		ImageIcon imgMostrarRI = new ImageIcon(Juego.class.getResource("/imagenes_casillas/mostrar ri p.png"));
		...
		ImageIcon imgCuclillasRI = new ImageIcon(Juego.class.getResource("/imagenes_casillas/cuclillas ri p.png"));
		...
		ImageIcon imgQuedarseRI = new ImageIcon(Juego.class.getResource("/imagenes_casillas/quedarse ri p.png"));
		...
		ImageIcon imgSusurro = new ImageIcon(Juego.class.getResource("/imagenes_casillas/susurro p.png"));
		...
		ImageIcon imgTocar = new ImageIcon(Juego.class.getResource("/imagenes_casillas/tocar p.png"));
		Image tocarArr = imgTocar.getImage().getScaledInstance(120, 90, Image.SCALE_SMOOTH);
		Icon iconTocar = new ImageIcon(tocarArr);
		
		ImageIcon imgAtar = new ImageIcon(Juego.class.getResource("/imagenes_casillas/atala p.png"));
		...
		c00.setImagenP(new ImageIcon(Juego.class.getResource("/imagenes_casillas/00 salida p.png")));
		...
		c01.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/01 confesion.png")));
		...
		c02.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/02 ropa fuera.png")));
		...
		c03.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/03 masaje.png")));
		...
		c04.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/04 beso.png")));
		...
		c05.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/05 ropa fuera.png")));
		...
		c06.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/06 nalgada.png")));
		...
		c07.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/07 susurro.png")));
		...
		c08.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/08 ri.png")));
		...
		c09.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/09 confesion.png")));
		...
		c10.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/10 tocar.png")));
		...
		c11.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/11 ri.png")));
		...
		c12.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/12 ropa fuera.png")));
		...
		c13.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/13 baile sexy.png")));
		...
		c14.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/14 beso.png")));
		...
		c15.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/15 a ciegas.png")));
		...
		c16.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/16 lamer.png")));
		...
		c17.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/17 masaje.png")));
		...
		c19.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/19 beso.png")));
		...
		c20.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/20 baile sexy.png")));
		...
		c21.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/21 beso carinyoso.png")));
		...
		c22.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/22 ropa fuera.png")));
		...
		c23.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/23 a ciegas.png")));
		...
		c25.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/25 descripcion.png")));
		...
		c26.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/26 lamer.png")));
		...
		c27.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/27 confesion.png")));
		...
		c28.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/28 morder.png")));
		...
		c29.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/29 beso.png")));
		...
		c30.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/30 lamer.png")));
		...
		c31.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/31 ri.png")));
		...
		c32.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/32 beso cuello.png")));
		...
		c33.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/33 atala.png")));
		...
		Casilla c35 = new Casilla("Coge mis manos y ense�ame como te gusta que te toque");
		c35.setImagenP(iconDemostracion);
		c35.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/35 demostracion.png")));
		...
		c36.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/36 tocar.png")));
		...
		c37.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/37 beso.png")));
		...
		c39.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/39 escoge prueba.png")));
		...
		c40.setImagenP(new ImageIcon(Juego.class.getResource("/imagenes_casillas/40 escoge tu premio p.png")));
		c40.setImagenG(new ImageIcon(Juego.class.getResource("/imagenes_casillas/40 escoge tu premio g.png")));
